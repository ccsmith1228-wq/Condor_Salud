    ...
    <div className="flex-1 overflow-y-auto px-8 py-6">
      ...
      {step.proTip && (
        <section className="mb-6">
          <div className="rounded-xl border border-gold-200 bg-gradient-to-br from-gold-50 to-white p-5 shadow-sm">
            <div className="mb-1 flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-gold-700">Pro Tip</h3>
            </div>
