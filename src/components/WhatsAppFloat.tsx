...
export default function WhatsAppFloat() {
  ...
  const waMessage = encodeURIComponent(t("wa.message"));

  return (
    <div className="fixed bottom-6 left-6 z-[90] flex items-end gap-3">
      {/* Tooltip */}
      {tooltip && (
        <div className="bg-white text-ink text-xs font-semibold px-4 py-2.5 rounded-lg shadow-lg border border-border animate-fadeIn whitespace-nowrap mb-1">
          {t("wa.tooltip")}
        </div>
      )}
